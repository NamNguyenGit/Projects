    ...
    <div class="row">
      <div class="col-md-12">
        <div class="x_panel">
          ...
          <div class="x_content">
            <br>
            <form class="form-horizontal form-label-left" method="POST" action="{{route('product.update',$product->id)}}" enctype="multipart/form-data">
              @csrf @method('PUT')
              <div class="container">
                <div class="row">
                  <div class="col-md-7">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-md-9 col-sm-9">
                        <textarea name="content" class="w-100 form-control motcongmotbanghai" rows="7">{!!$product->content!!}</textarea>
                        @error('content')
                        <small class="text-danger">{{$message}}</small>
                        @enderror
                      </div>
                  ...
                  <div class="col-md-5">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-md-9 col-sm-9">
                        <select name="color_id" class="form-control">
                          ...
                          <option value="{{$colors->id}}" {{$colors->id == $product->color_id ? 'selected' : ''}}>{{$colors->name}}</option>
                          @endforeach
                        </select>
                        @error('color_id')
                        <small class="text-danger">{{$message}}</small>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-md-9 col-sm-9">
                        <select name="size_id" class="form-control">
                          ...
                          <option value="{{$sizes->id}}" {{$sizes->id == $product->size_id ? 'selected' : ''}}>{{$sizes->name}}</option>
                          @endforeach
                        </select>
                        @error('size_id')
                        <small class="text-danger">{{$message}}</small>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-md-9 col-sm-9">
                        <img src="/frontend/img/product/{{$product->image}}" alt="" width="100px">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-md-9 col-sm-9">
                        <div class="radio">
                          <label>
                            <input type="radio" class="flat" name="status" value="1" {{$product->status == 1 ? 'checked' : ''}}> Còn hàng
                          </label>
                        </div>
                        <div class="radio">
                          <label>
                            <input type="radio" class="flat" name="status" value="0" {{$product->status == 0 ? 'checked' : ''}}> Hết hàng
                          </label>
                        </div>
                      </div>
                    </div>
